...
printf "Fasta1 is $fasta1" >>$log
printf "Fasta2 is §fasta2" >>$log
...
snaptools snap-pre  \
	--input-file=$SCRIPTPATH"/"$t_name".bam"  \
	--output-snap=$t_name".snap"  \
	--genome-name=hg38  \
...
snaptools snap-add-bmat	\
	--snap-file=$SCRIPTPATH"/"$t_name".snap" 	\
